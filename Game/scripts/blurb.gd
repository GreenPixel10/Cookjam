...
var blurbs = [
	...
	"Press TAB to view the recipe book. Use A/D to find the recipe for Mouse Bites",
	"Follow the recipe! You can use weapons for both fighting and meal prepping. Toss items to combine them or to put them into workstations like the fireplace.",
